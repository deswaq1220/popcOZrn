...
export interface Movie {
  ...
  export const movies: Movie[] = [
    ...
    {
      title: "시민덕희",
      poster: "/src/img/posters/시민덕희.jpeg", price: 13000
    },
    {
      title: "외계인+2부",
      poster: "/src/img/posters/외계인.jpeg", price: 12000
    },
    { title: "소풍", poster: "/src/img/posters/소풍.jpeg", price: 12000 }, 
    {
      title: "도그데이즈",
      poster: "/src/img/posters/도그데이즈.jpeg", price: 12000
    },
  ];
  ...
  return (
    <div className="ticketing-container">
      ...
      <Seat selectedCount={selectedCount} setSelectedCount={setSelectedCount} movies={movies} selectedIndex={selectedIndex}/>
